...
class Filter(object):
    ...
    def build_model(self, is_training):
        ...
        with tf.variable_scope("TrainOps"):
            ...
            gradvars2 = opt2.compute_gradients(self.rl, r_vars, colocate_gradients_with_ops=False)
            ...
            gradvars3 = opt3.compute_gradients(self.J_loss + self.error_loss_pos + self.error_loss_vel + self.error_loss_acc, q_vars, colocate_gradients_with_ops=False)
